...
class MainWindow(object):
    ...
    def open_pda(self):
        ...
        if file_name:
            ...
            f.node(' ')
            if self.pda.initial_state in self.pda.final_states:
    ...
    def convert_to_cfg(self):
        ...
        messageBox.setText('<font size=5>' + '<br>'.join(self.cfg) + '</font>')
        messageBox.setWindowTitle('Result CFG')
        messageBox.exec_()


    def show_about_dialog(self):
        QtWidgets.QMessageBox.information(self.central_widget, 'About me', 'Programmers: Rishabh Pathak & Pranjal Yadav')